...
(2, 'The Masterplan', (SELECT artist_id FROM artists WHERE name = 'The Masterplan' LIMIT 1), 2, (SELECT genre_id FROM genres WHERE name = 'Alternative Rock' LIMIT 1), '1998-11-17', 12.99, '/images/Oasis – The Masterplan (1).webp', NOW(), NOW()),
...
(6, 'Barbie the Album', (SELECT artist_id FROM artists WHERE name = 'Original Soundtrack' LIMIT 1), 6, (SELECT genre_id FROM genres WHERE name = 'Soundtrack' LIMIT 1), '2023-07-21', 30.00, '/images/Original Soundtrack – Barbie the Album.webp', NOW(), NOW()),
(7, 'Guardians of the Galaxy - Awesome Mix 1', (SELECT artist_id FROM artists WHERE name = 'Original Soundtrack' LIMIT 1), 7, (SELECT genre_id FROM genres WHERE name = 'Soundtrack' LIMIT 1), '2014-07-29', 40.00, '/images/Original Soundtrack – Guardians of the Galaxy - Awesome Mix 1.webp', NOW(), NOW()),
(8, 'Pulp Fiction', (SELECT artist_id FROM artists WHERE name = 'Original Soundtrack' LIMIT 1), 8, (SELECT genre_id FROM genres WHERE name = 'Soundtrack' LIMIT 1), '1994-09-27', 40.00, '/images/Original Soundtrack – Pulp Fiction.webp', NOW(), NOW()),
(9, 'The Greatest Showman', (SELECT artist_id FROM artists WHERE name = 'Original Soundtrack' LIMIT 1), 9, (SELECT genre_id FROM genres WHERE name = 'Soundtrack' LIMIT 1), '2017-12-08', 25.00, '/images/Motion Picture Cast Recording – The Greatest Showman.webp', NOW(), NOW()),
(10, 'Baby Driver', (SELECT artist_id FROM artists WHERE name = 'Original Soundtrack' LIMIT 1), 10, (SELECT genre_id FROM genres WHERE name = 'Soundtrack' LIMIT 1), '2017-07-23', 35.00, '/images/Original Soundtrack – Baby Driver.webp', NOW(), NOW()),
...
(25, 'Ready to Die', (SELECT artist_id FROM artists WHERE name = 'The Notorious B.I.G.' LIMIT 1), 25, (SELECT genre_id FROM genres WHERE name = 'Hip-hop' LIMIT 1), '1994-09-13', 50.00, '/images/51pil+A8wQL._UF894,1000_QL80_.jpg', NOW(), NOW());
