    ...
    return (
        <main className="pop-page">
            <section className="pop-products">
                <h2>Pop Albums</h2>
                <div className="pop-product-grid">
                    {products.map(product => (
                        <div key={product.product_id} className="pop-product-card" onClick={() => openPopup(product.product_id)}>
                            <div className="pop-product-container">
                                <img src={`http://localhost:5001${product.cover_image_url}`} alt={product.album_name} className="pop-product-image" />
                                <button
                                ...
                                <div className="pop-product-info">
                                    <h3>{product.album_name}</h3>
                                    <p>{product.artist_name}</p>
                                    <p>{product.price}</p>
                                </div>
                                <div className="pop-product-actions">
