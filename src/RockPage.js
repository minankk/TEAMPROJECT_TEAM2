...
const RockPage = () => {
    ...
    return (
        <main className="products-page">
            <section className="rock-products">
                <h2>Rock Albums</h2>
                <div className="rock-product-grid">
                    {products.map(product => (
                        <div key={product.product_id} className="rock-product-card" onClick={() => openPopup(product.product_id)}>
                            <div className="rock-product-container">
                                <img src={`http://localhost:5001${product.cover_image_url}`} alt={product.album_name} className="rock-product-image" />
                                <button
                                ...
                                <div className="rock-product-info">
                                    <h3>{product.album_name}</h3>
                                    <p>{product.artist_name}</p>
                                    <p>£{product.price}</p>
                                </div>
                                <div className="rock-product-actions">
