...
import { faLock } from "@fortawesome/free-solid-svg-icons"; // Example icon
  ...
  return (
    <div className="policy-container">
      ...
      <section>
        ...
        <p>To exercise any of these rights, please <a href="http://localhost:3000/contact-us">contact us</a> using the information provided below.</p>
      </section>
