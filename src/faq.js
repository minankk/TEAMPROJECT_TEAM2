...
const FAQ = () => {
  const faqData = [
    ...
    },
    {
      ...
      answer:
        "We are an online-only store, allowing us to reach a global audience and offer competitive prices.",
    },
    {
      question: "How can I get in touch with customer support?",
      answer:
        "Click on the 'Customer Support' button at the bottom of the page or email us at support@vinylstore.com.",
    },
    {
      question: "How do I sign up for a Vinyl Vault account?",
      answer:
        "Click on the 'Sign Up' button, enter your details, and follow the instructions to create an account.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Shipping times vary by location but typically range from 3 to 10 business days.",
    },
    {
      question: "Do you ship internationally?",
      answer:
        "Yes! We ship worldwide. Shipping costs and times may vary depending on your location.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes! We frequently stock limited edition and rare vinyl records, so be sure to check our new arrivals.",
    },
    {
      question: "Can I cancel an order after I've placed it?",
      answer:
        "Orders can only be canceled within 24 hours of purchase. After that, they are processed for shipping.",
    },
  ];
  ...
  return (
    <div
      className="faq-background pulsating-overlay"
